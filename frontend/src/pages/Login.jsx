...
export default function Login() {
  const { formData, formError, handleChange, handleSubmit } = useLoginForm();
    ...
    <AuthLayout illustrationType="security">
      <div className="fade-in">
        <div className="auth-header">
          <h1>Welcome back</h1>
          <p>Login to access your secure developer dashboard</p>
        </div>

        {/* Display System Feedback Alerts */}
        ...
        <div className="social-buttons">
          <button
            ...
            onClick={() => alert("Google OAuth login triggered")}
            disabled={loading}
          >
            <svg viewBox="0 0 24 24" width="16" height="16" style={{ marginRight: "0.25rem" }}>
          ...
          <button
            type="button"
            className="btn-social"
            onClick={() => alert("GitHub OAuth login triggered")}
            disabled={loading}
          >
            <svg viewBox="0 0 24 24" width="16" height="16" style={{ marginRight: "0.25rem" }} fill="currentColor">
